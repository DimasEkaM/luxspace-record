...
function slide(wrapper, items){
    let posX1 = 0, posX2 = 0, posInitial, posFinal, treshold = 100,
    itemToShow=4, slides = items.getElementsByClassName("card"), slidesLenght = slide.length,
    ...
    function checkIndex(){
        ...
        if(index == slidesLenght - itemToShow){
            items.style.left = -((slidesLenght - itemToShow - 1) * slideSize)+"px"
            index = slidesLenght - itemToShow - 1
        }

        if(index == slidesLenght || index == slidesLenght - 1){
